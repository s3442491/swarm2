...
class TargetNav2Pattern(MovementPattern):
    """
    ...
    def __init__(self):
        ...
        super().__init__('target_nav2_pattern')
...
def main(args=None):
    """
    Create a node for the drive pattern, spin it and handle the setup.
    """
    setup_node.init_and_spin(args, TargetNav2Pattern)
