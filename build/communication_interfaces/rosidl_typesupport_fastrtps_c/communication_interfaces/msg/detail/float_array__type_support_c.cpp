...
#include "communication_interfaces/msg/detail/float_array__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // floats
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // floats

// forward declare type support functions


using _FloatArray__ros_msg_type = communication_interfaces__msg__FloatArray;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: floats
  {
    ...
    if (ros_message->floats.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->floats);
    }
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->floats, size)) {
      return "failed to create array for field 'floats'";
    }
    auto array_ptr = ros_message->floats.data;
...
size_t get_serialized_size_communication_interfaces__msg__FloatArray(
  const void * untyped_ros_message,
...
static uint32_t _FloatArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_interfaces__msg__FloatArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_interfaces
size_t max_serialized_size_communication_interfaces__msg__FloatArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_communication_interfaces__msg__FloatArray(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_interfaces, msg, FloatArray)() {
