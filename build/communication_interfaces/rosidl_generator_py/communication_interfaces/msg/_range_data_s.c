...
bool communication_interfaces__msg__range_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("communication_interfaces.msg._range_data.RangeData", full_classname_dest, 50) == 0);
  }
  communication_interfaces__msg__RangeData * ros_message = _ros_message;
  {  // header
...
PyObject * communication_interfaces__msg__range_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("communication_interfaces.msg._range_data");
