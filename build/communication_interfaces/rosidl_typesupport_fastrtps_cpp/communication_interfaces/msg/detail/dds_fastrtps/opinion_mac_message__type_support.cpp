...
#include "communication_interfaces/msg/detail/opinion_mac_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const communication_interfaces::msg::OpinionMACMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_interfaces::msg::OpinionMACMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OpinionMACMessage__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const communication_interfaces::msg::OpinionMACMessage *>(
...
{
  return max_serialized_size_OpinionMACMessage(full_bounded, 0);
}

static message_type_support_callbacks_t _OpinionMACMessage__callbacks = {
...
static rosidl_message_type_support_t _OpinionMACMessage__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OpinionMACMessage__callbacks,
...
{
  return &communication_interfaces::msg::typesupport_fastrtps_cpp::_OpinionMACMessage__handle;
}
