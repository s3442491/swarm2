...
static const _OpinionMACMessage_type_support_symbol_names_t _OpinionMACMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_interfaces, msg, OpinionMACMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, communication_interfaces, msg, OpinionMACMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, communication_interfaces, msg, OpinionMACMessage)() {
  return &::communication_interfaces::msg::rosidl_typesupport_c::OpinionMACMessage_message_type_support_handle;
}
