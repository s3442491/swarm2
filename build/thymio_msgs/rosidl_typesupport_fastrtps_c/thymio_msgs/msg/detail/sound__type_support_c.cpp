...
#include "thymio_msgs/msg/detail/sound__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_thymio_msgs
...
using _Sound__ros_msg_type = thymio_msgs__msg__Sound;
...
size_t get_serialized_size_thymio_msgs__msg__Sound(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Sound__ros_msg_type * ros_message = static_cast<const _Sound__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Sound__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_thymio_msgs__msg__Sound(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_thymio_msgs
size_t max_serialized_size_thymio_msgs__msg__Sound(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_thymio_msgs__msg__Sound(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, thymio_msgs, msg, Sound)() {
