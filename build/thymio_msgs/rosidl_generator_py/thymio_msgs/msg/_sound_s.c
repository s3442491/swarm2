...
bool thymio_msgs__msg__sound__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("thymio_msgs.msg._sound.Sound", full_classname_dest, 28) == 0);
  }
  thymio_msgs__msg__Sound * ros_message = _ros_message;
  {  // duration
...
PyObject * thymio_msgs__msg__sound__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("thymio_msgs.msg._sound");
